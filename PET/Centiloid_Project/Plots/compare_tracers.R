...
# 1. Load your data
# -----------------------------
data_file <- "/Volumes/vdrive/helpern_users/helpern_j/IAM/IAM_Analysis/IAM_BIDS/derivatives/pet/centiloid_project/Calibrated-Coefficients/centiloids_both_tracers.csv"
...
ggsave("/Volumes/vdrive/helpern_users/helpern_j/IAM/IAM_Analysis/IAM_BIDS/derivatives/pet/centiloid_project/Calibrated-Coefficients/MeanSUVR_by_Tracer.pdf", p1, width=6, height=5)
ggsave("/Volumes/vdrive/helpern_users/helpern_j/IAM/IAM_Analysis/IAM_BIDS/derivatives/pet/centiloid_project/Calibrated-Coefficients/Centiloid_by_Tracer.pdf", p2, width=6, height=5)
ggsave("/Volumes/vdrive/helpern_users/helpern_j/IAM/IAM_Analysis/IAM_BIDS/derivatives/pet/centiloid_project/Calibrated-Coefficients/Combined_SUVR_Centiloid.pdf", combined_plot, width=12, height=5)
